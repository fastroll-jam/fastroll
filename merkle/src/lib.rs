...
#[derive(Debug, Error)]
pub enum GeneralMerkleError {
    #[error("CryptoError: {0}")]
    CryptoError(#[from] CryptoError),
}

pub fn node<H: Hasher>(data: &[Octets]) -> Result<Octets, GeneralMerkleError> {
...
#[test]
fn test_node_empty() -> Result<(), GeneralMerkleError> {
    let data: &[Octets] = &[];
...
#[test]
fn test_node_single_element() -> Result<(), GeneralMerkleError> {
...
#[test]
fn test_node_two_elements() -> Result<(), GeneralMerkleError> {
...
#[test]
fn test_node_three_elements() -> Result<(), GeneralMerkleError> {
...
#[test]
fn test_node_five_elements() -> Result<(), GeneralMerkleError> {
