...
#[derive(
    Debug, Default, Clone, PartialEq, Eq, Hash, Serialize, Deserialize, JamEncode, JamDecode,
)]
...
#[derive(
    Debug, Default, Clone, Hash, PartialEq, Eq, Serialize, Deserialize, JamEncode, JamDecode,
)]
