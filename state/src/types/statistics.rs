...
// FIXME: This is a workaround codec implementation for BTreeMap with service_id keys. This doesn't
// FIXME: align with GP but needed to pass traces test vectors.
